...
import ResumeDownload from '../assets/Ayush-Gour-SDE.pdf';
...
export default function Profile() {
  ...
  const handleDownload = () => {
    ...
    link.href = "/Ayush-Gour-SDE.pdf"; // Path to the file
    link.download = "Ayush-Gour-SDE.pdf"; // File name for download
